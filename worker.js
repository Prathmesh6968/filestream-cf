...
const BOT_TOKEN = "8473951219:AAFCIMVWa6iwCJgiMtOEha8g4MdyT8N3tQg"; // Insert your bot token.
const BOT_WEBHOOK = "/endpoint"; // Let it be as it is.
const BOT_SECRET = "FhffDdhdggsghdd4jfDJHFDSHHSdhgdsKfaAghashGGGggseu4488584"; // Insert a powerful secret text (only [A-Z, a-z, 0-9, _, -] are allowed).
const BOT_OWNER = 2112998631; // Insert your telegram account id.
const BOT_CHANNEL = -1003395114356; // Insert your telegram channel id which the bot is admin in.
const SIA_SECRET = "tAAyfCXJvb2cgtP5pnzW"; // Insert a powerful secret text and keep it safe.
